# Generated by Django 4.2.7 on 2023-11-09 08:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.CharField(choices=[('Fintech', 'Fintech'), ('Learning Institution', 'Learning Institution'), ('Transportation', 'Transportation')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='onboard.customer')),
            ],
        ),
    ]
